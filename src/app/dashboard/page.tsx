    ...
    <div className="space-y-8">
      <Card className="overflow-hidden">
        <div className="relative">
          ...
          <div className="absolute bottom-0 left-0 p-6">
            <h1 className="font-headline text-3xl font-bold text-white">Welcome Back, Student!</h1>
            <p className="text-white/80 mt-2 max-w-2xl">Ready to dive back in? Your learning journey continues here.</p>
          </div>
        </div>
      </Card>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {features.map((feature) => (
          <Card key={feature.title} className="flex flex-col transform hover:-translate-y-1 transition-transform duration-300">
